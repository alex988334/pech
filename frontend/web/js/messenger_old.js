...
let MESSAGE_SEND = 111;
let MESSAGE_DELIVERED = 112;
let MESSAGE_READED = 113;

let MESSAGE_SEND_STR = 'send';
let MESSAGE_DELIVERED_STR = 'delivered';
let MESSAGE_READED_STR = 'readed';
...
function createMessage(elem, id_user){     
    ...
    if (id_user == elem.id_user) {
        ...
        switch (elem.status_message) {
            case MESSAGE_SEND_STR: src = '/images/send.png';
                break;
            case MESSAGE_DELIVERED_STR: src = '/images/delivered.png';
                break;
            case MESSAGE_READED_STR: src = '/images/readed.png';
                break;
        }
...
function createWebSocket(){
    chat = new WebSocket(protocol + '://' + HOST_NAME + ':25555');
